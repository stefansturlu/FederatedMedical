...
class CustomConfig(DefaultExperimentConfiguration):
    def __init__(self):
        ...
        experimentString = 'FedADF'
        
        self.scenarios: AttacksType = [
            #([], [], [], f"no_attack {iidString} {experimentString}"),
            #([2, ], [], [], f"1_faulty {iidString} {experimentString}"),
            #([2, 5], [], [], f"2_faulty {iidString} {experimentString}"),
            #([2, 5, 8], [], [], f"3_faulty {iidString} {experimentString}"),
            #([2, 5, 8, 11], [], [], f"4_faulty {iidString} {experimentString}"),
            #([2, 5, 8, 11, 14], [], [], f"5_faulty {iidString} {experimentString}"),
            #([2, 5, 8, 11, 14, 17], [], [], f"6_faulty {iidString} {experimentString}"),
            #([2, 5, 8, 11, 14, 17, 20], [], [], f"7_faulty {iidString} {experimentString}"),
            #([2, 5, 8, 11, 14, 17, 20, 23], [], [], f"8_faulty {iidString} {experimentString}"),
            #([2, 5, 8, 11, 14, 17, 20, 23, 26], [], [], f"9_faulty {iidString} {experimentString}"),
            #([2, 5, 8, 11, 14, 17, 20, 23, 26, 29], [], [], f"10_faulty {iidString} {experimentString}"),
            #([], [2, ], [], f"1_mal {iidString} {experimentString}"),
            #([], [2, 5], [], f"2_mal {iidString} {experimentString}"),
            #([], [2, 5, 8], [], f"3_mal {iidString} {experimentString}"),
            #([], [2, 5, 8, 11], [], f"4_mal {iidString} {experimentString}"),
            #([], [2, 5, 8, 11, 14], [], f"5_mal {iidString} {experimentString}"),
            #([], [2, 5, 8, 11, 14, 17], [], f"6_mal {iidString} {experimentString}"),
            #([], [2, 5, 8, 11, 14, 17, 20], [], f"7_mal {iidString} {experimentString}"),
            #([], [2, 5, 8, 11, 14, 17, 20, 23], [], f"8_mal {iidString} {experimentString}"),
            #([], [2, 5, 8, 11, 14, 17, 20, 23, 26], [], f"9_mal {iidString} {experimentString}"),
            #([], [2, 5, 8, 11, 14, 17, 20, 23, 26, 29], [], f"10_mal {iidString} {experimentString}"),
            #([2, 5, ], [17, 20, ], [], f"2_faulty_2_mal {iidString} {experimentString}"),
            ([1, 4, 7, 10, 13], [17, 20, 23, 26, 29], [], f"5_faulty_5_mal {iidString} {experimentString}"),
        ]
        self.percUsers = torch.tensor(PERC_USERS, device=self.aggregatorConfig.device)

        self.aggregators = [FedADFAggregator, ]
        #self.aggregators = [FAAggregator, COMEDAggregator, MKRUMAggregator, AFAAggregator, FedMGDAPlusPlusAggregator, FedBEAggregator, FedDFAggregator, FedADFAggregator]
